...
public class Assignment1 {
	...
	public void setup() {
	 ...
	 @DataProvider(name = "loginData")
	    ...
	    // Test annotation to perform the login functionality
	    ...
	    public void testLogin(String username, String password) {
	    	...
	    	// Wait briefly and try to close Chrome's native popup if it appears
	    	try {
	    	...
	    	Assert.assertEquals(driver.getCurrentUrl(), expectedUrl , "Login failed with username and passwors : " +username + " " +password );
	    }
